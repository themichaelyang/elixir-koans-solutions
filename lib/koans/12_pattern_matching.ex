defmodule PatternMatching do
  ...
  koan "Strings come apart just as easily" do
    ...
    # concat strings is short for bitstrings
    # https://stackoverflow.com/a/50914905/
  ...
  koan "The pattern can make assertions about what it expects" do
    # match? is a macro! patterns are not a type of data
    # https://hexdocs.pm/elixir/master/Kernel.html#match?/2
    # actually the source code of this is simple and makes a lot of sense!
  ...
  koan "Errors are shaped differently than successful results" do
    # Not always true. {:error, reason} is a convention
