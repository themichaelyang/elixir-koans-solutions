defmodule MapSets do
  ...
  koan "I am very similar to a list" do
    # https://stackoverflow.com/q/40392012/7971276
    # Ordering is not guaranteed to be preserved!
  ...
  koan "You cannot depend on my order" do
    ...
    # Note that if the implementation changes in the future, there is no
    # guarantee of ordering. You should not depend on this!
  end
